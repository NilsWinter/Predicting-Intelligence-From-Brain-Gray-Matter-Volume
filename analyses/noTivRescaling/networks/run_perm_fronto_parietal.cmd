#!/bin/bash
#
#SBATCH --job-name=perm_fronto_parietal_noTiv
#SBATCH --output=/scratch/tmp/wintern/iq_frankfurt/analyses/noTivRescaling/networks/output_fronto_parietal_noTiv.dat
...
python3 perm_networks.py $row 5