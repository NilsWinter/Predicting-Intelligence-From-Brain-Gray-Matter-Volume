#!/bin/bash
#
#SBATCH --job-name=perm_dorsal_attention_noTiv
#SBATCH --output=/scratch/tmp/wintern/iq_frankfurt/analyses/noTivRescaling/networks/output_dorsal_attention_noTiv.dat
...
python3 perm_networks.py $row 2