#!/bin/bash
#
#SBATCH --job-name=fronto_parietal_noTiv
#SBATCH --output=/scratch/tmp/wintern/iq_frankfurt/analyses/noTivRescaling/networks/fronto_parietal_noTiv.dat
