#!/bin/bash
#
#SBATCH --job-name=perm_default_mode_noTiv
#SBATCH --output=/scratch/tmp/wintern/iq_frankfurt/analyses/noTivRescaling/networks/output_default_mode_noTiv.dat
...
python3 perm_networks.py $row 6