#!/bin/bash
#
#SBATCH --job-name=perm_limbic_noTiv
#SBATCH --output=/scratch/tmp/wintern/iq_frankfurt/analyses/noTivRescaling/networks/output_limbic_noTiv.dat
...
python3 perm_networks.py $row 4