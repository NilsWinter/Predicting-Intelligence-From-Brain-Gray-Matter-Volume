#!/bin/bash
#
#SBATCH --job-name=perm_visual_noTiv
#SBATCH --output=/scratch/tmp/wintern/iq_frankfurt/analyses/noTivRescaling/networks/output_perm_visual_noTiv.dat
...
python3 perm_networks.py $row 0