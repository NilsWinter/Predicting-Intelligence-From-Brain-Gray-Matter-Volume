#!/bin/bash
#
#SBATCH --job-name=perm_cerebellum_noTiv
#SBATCH --output=/scratch/tmp/wintern/iq_frankfurt/analyses/noTivRescaling/networks/output_cerebellum_noTiv.dat
...
python3 perm_networks.py $row 8