#!/bin/bash
#
#SBATCH --job-name=ventral_attention_noTiv
#SBATCH --output=/scratch/tmp/wintern/iq_frankfurt/analyses/noTivRescaling/networks/ventral_attention_noTiv.dat
