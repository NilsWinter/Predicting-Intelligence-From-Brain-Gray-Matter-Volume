...
Description
-----------
Permutation script for schaefer regional analysis with NoTivRescaling
...
def run_perm_test(row):
    ...
    for network in networks:
        analysis_name = 'schaefer_{}_noTiv_perm_'.format(network) + str(perm_ind)
        data_folder = '/scratch/tmp/wintern/iq_frankfurt/'
        project_folder = '/scratch/tmp/wintern/iq_frankfurt/results/noTivRescaling/perm/schaefer_{}'.format(network)
