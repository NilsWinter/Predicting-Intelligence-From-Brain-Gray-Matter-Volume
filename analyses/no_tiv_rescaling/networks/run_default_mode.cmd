#!/bin/bash
#
#SBATCH --job-name=default_mode_noTiv
#SBATCH --output=/scratch/tmp/wintern/iq_frankfurt/analyses/noTivRescaling/networks/default_mode_noTiv.dat
