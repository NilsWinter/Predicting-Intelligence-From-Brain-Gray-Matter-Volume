#!/bin/bash
#
#SBATCH --job-name=perm_somatomotor_noTiv
#SBATCH --output=/scratch/tmp/wintern/iq_frankfurt/analyses/noTivRescaling/networks/output_perm_somatomotor_noTiv.dat
...
python3 perm_networks.py $row 1