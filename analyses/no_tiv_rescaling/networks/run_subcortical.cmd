#!/bin/bash
#
#SBATCH --job-name=subcortical_noTiv
#SBATCH --output=/scratch/tmp/wintern/iq_frankfurt/analyses/noTivRescaling/networks/subcortical_noTiv.dat
