...
Description
-----------
Permutation script for schaefer analysis with NoTivRescaling
...
def run_perm_test(row):
    ...
    analysis_name = 'aal_noTiv_perm_' + str(perm_ind)
    data_folder = '/scratch/tmp/wintern/iq_frankfurt/'
    project_folder = '/scratch/tmp/wintern/iq_frankfurt/results/noTivRescaling/perm/aal'
